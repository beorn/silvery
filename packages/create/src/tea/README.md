...
import type { TeaResult, TeaReducer, EffectRunners, TeaSlice, EffectLike } from "@silvery/create"
```
...
import { tea } from "@silvery/create"
...
```ts
import { createStore } from "zustand"
import { tea, type TeaResult, type EffectRunners } from "@silvery/create"
...
```ts
import { collect } from "@silvery/create"
