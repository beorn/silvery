...
| `patchConsole`    | `boolean` | `true`  | Patch console methods to work with hightea output       |
...
```tsx
import { render, Text, createTerm } from "@hightea/term"
...
```tsx
import { render, Box, Text, useApp, useInput, createTerm } from "@hightea/term"
...
```tsx
import { render, Box, Text, useTerm, createTerm } from "@hightea/term"
...
```tsx
import { render, renderSync, Text, createTerm } from "@hightea/term"
