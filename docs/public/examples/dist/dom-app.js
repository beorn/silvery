...
// vendor/silvery/packages/ag-term/src/adapters/dom-adapter.ts
var DEFAULT_CONFIG = {
  fontSize: 14,
...
function createDOMMeasurer(_config) {
  return {
  ...
  render() {
    ...
    for (const [y, runs] of sortedLines) {
      ...
      for (const run of sortedRuns) {
        ...
        const styles = [`position: absolute`, `left: ${run.x * cw}px`];
        if (run.style.fg) {
        ...
        if (attrs) {
          ...
          if (attrs.underline || attrs.underlineStyle) {
            ...
            const underlineColor = attrs.underlineColor ? resolveColor(attrs.underlineColor, this.config.foregroundColor) : "currentColor";
          ...
          if (attrs.inverse) {
            const fg = run.style.fg ? resolveColor(run.style.fg, this.config.foregroundColor) : this.config.foregroundColor;
            const bg = run.style.bg ? resolveColor(run.style.bg, this.config.backgroundColor) : this.config.backgroundColor;
...
function createDOMAdapter(config = {}) {
  ...
  return {
    ...
    flush(buffer, _prevBuffer) {
      const domBuffer = buffer;
...
function injectDOMStyles(classPrefix = "silvery") {
...
// vendor/silvery/packages/ag-term/src/dom/index.ts
var domAdapterFactory = { createAdapter: (config) => createDOMAdapter(config) };
function initDOMRenderer(config = {}) {
  initBrowserRenderer(domAdapterFactory, config);
}
function renderToDOM(element, container, options = {}) {
  ...
  const base = createBrowserRenderer(element, cols, rows, (buffer) => {
...
// vendor/silvery/examples/web/dom-app.tsx
  ...
  return /* @__PURE__ */ jsx_runtime3.jsxs(Box, {
    ...
    children: [
        ...
        children: /* @__PURE__ */ jsx_runtime3.jsxs(Box, {
          ...
          children: [
            /* @__PURE__ */ jsx_runtime3.jsx(Text, {
              bold: true,
              color: "cyan",
              children: "silvery DOM Rendering"
            }),
      ...
      /* @__PURE__ */ jsx_runtime3.jsx(Box, {
        ...
        children: /* @__PURE__ */ jsx_runtime3.jsxs(Box, {
          ...
          children: [
            /* @__PURE__ */ jsx_runtime3.jsx(Text, {
              color: "magenta",
              children: "Text Styles (try selecting!)"
            }),
      ...
      /* @__PURE__ */ jsx_runtime3.jsx(Box, {
        ...
        children: /* @__PURE__ */ jsx_runtime3.jsx(Text, {
          dim: true,
          children: "Text is selectable! Screen readers work. CSS hover states available."
        })
      })
    ]
  });
...
if (container) {
  const instance = renderToDOM(/* @__PURE__ */ jsx_runtime3.jsx(App, {}), container, {
    fontSize: 14,
    fontFamily: "monospace"
  });
...
//# debugId=F9B2AAEFEEF4166F64756E2164756E21
