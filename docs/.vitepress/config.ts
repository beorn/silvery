      ...
      nav: [
        ...
        { text: "The Silvery Way", link: "/guide/the-silvery-way" },
        {
          ...
          items: [
            ...
            { text: "Token Taxonomy", link: "/guide/token-taxonomy" },
            { text: "Color Schemes", link: "/guide/color-schemes" },
            { text: "Capability Tiers", link: "/guide/capability-tiers" },
            { text: "Custom Tokens", link: "/guide/custom-tokens" },
            ...
            { text: "Term — the I/O umbrella", link: "/guide/term" },
