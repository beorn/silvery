...
| Hook | Description |
|---|---|
| [useContentRect](/api/use-content-rect) | Get component dimensions during render ([container queries for terminals](/getting-started/migrate-from-ink#_1-components-know-their-size-the-big-win)) |
...
```tsx
import {
  Box, Text, SelectList, TextInput, TextArea,
  ListView, Tabs, Table, Spinner, ProgressBar,
  render, useContentRect, useInput, useApp,
} from "silvery"
```
