...
| Hook                                    | Description                                                                                                                                             |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [useBoxRect](/api/use-content-rect) | Get component dimensions during render ([container queries for terminals](/getting-started/migrate-from-ink#_1-components-know-their-size-the-big-win)) |
