...
Renders a transparent Box (no visual impact) around children. Position tracking uses `useScrollRect` (zero re-renders). Requires a `PositionRegistryProvider` ancestor.
