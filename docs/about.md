...
- **[Pretext](https://chenglou.me/pretext/)** — text layout beyond CSS. Inspired Silvery's [text layout algorithms](/guide/pretext) (snug-content, balanced, optimal wrapping).
