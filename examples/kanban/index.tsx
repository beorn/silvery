...
function ColumnComponent({
	...
	const visibleCards = column.cards.slice(scrollOffset, scrollOffset + visibleCount);
	...
	return (
		...
		>
			...
			<Box flexDirection="column" paddingX={1} paddingY={1} overflow="hidden" flexGrow={1}>
				{hasMoreAbove && (
					<Text dim color="cyan">
...
function KanbanBoard(): JSX.Element {
	...
	}, [boundedSelectedCard, selectedColumn, visibleCardsPerColumn, scrollOffsets, currentColumnCards.length]);
