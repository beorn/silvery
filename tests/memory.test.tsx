...
describe("Yoga node cleanup", () => {
  ...
  test("container clear frees all nodes", () => {
    ...
    const { lastFrame: newFrame, unmount: newUnmount } = render2(
      <ManyChildren />,
    );
